    ...
    def __generate_thumbnail(self):
        try:
            ...
            if size[0] <= 200:
                ...
                self.progress_queue.put({"state":"true", "progress":"thumbnail", "imageId":self.pending_image_id, "imagePath":self.pending_image_path, "width":size[0], "height":size[1], "minZoom":3, "maxZoom":self.max_zoom})
                return
            ...
            import traceback
            traceback.print_exc()
            self.progress_queue.put({"state":"ERROR", "progress":"thumbnail", "imageId":self.pending_image_id, "imagePath":self.pending_image_path, "width":size[0], "height":size[1], "minZoom":3, "maxZoom":self.max_zoom})
